...
void setup(){
  ...
  /*
  <int x, int y, uint8_t radius, float data[], int start, int end, int triangleWidth, uint16_t colors, char names[][15], bool printNames>
  ...
  */
  ...
  gfx.drawPieChart(x, y, r, data, start, dataSize, triangleWidth, colors, names, printNames);
}
